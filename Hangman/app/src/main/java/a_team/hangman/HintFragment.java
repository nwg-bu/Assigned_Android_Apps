...
public class HintFragment extends Fragment {
    ...
    private HintFragmentListener hintFragmentListener;

    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";

    private String[] hints = new String[]{"FRUIT", "FURNITURE", "CITY", "VISION", "CAFFEINE", "PHONE OS", "COCKTAIL"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hintText = (TextView) view.findViewById(R.id.tvHint);
        int index = hintFragmentListener.getHintIndex();
    ...
    public void onAttach(Context context) {
        ...
        hintFragmentListener = (HintFragmentListener) context;
    }
